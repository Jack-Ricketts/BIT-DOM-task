...
const veiksmasPlius = '+';
const veiksmasMinus = '-';
const veiksmasDalyba = '/';
const veiksmasDaugyba = '*';
const pirmas = 7;
const antras = 5;
const trecias = 2;
...
console.log(`${matematika[veiksmasPlius](pirmas, antras)}`);
console.log(`${matematika[veiksmasPlius](antras, trecias)}`);
console.log(`${matematika[veiksmasPlius](pirmas, trecias)}`);

console.log(`${matematika[veiksmasMinus](pirmas, antras)}`);
console.log(`${matematika[veiksmasMinus](antras, trecias)}`);
console.log(`${matematika[veiksmasMinus](pirmas, trecias)}`);

console.log(`${matematika[veiksmasDalyba](pirmas, antras)}`);
console.log(`${matematika[veiksmasDalyba](antras, trecias)}`);
console.log(`${matematika[veiksmasDalyba](pirmas, trecias)}`);

console.log(`${matematika[veiksmasDaugyba](pirmas, antras)}`);
console.log(`${matematika[veiksmasDaugyba](antras, trecias)}`);
console.log(`${matematika[veiksmasDaugyba](pirmas, trecias)}`);/*
object = {
    key: value,
    key: value,
    key: value,
